        ...
        <tbody>
            <?php foreach ($dadosCliente as $usuarios) { ?>
                <tr>
                    ...
                    <td>
                        <a href="editarUsuario.php?id=<?php echo $usuarios['id']; ?>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i>    </a>
                    </td>
                    <td>
                        <button onclick="atualizarUsuario(<?php echo $usuarios['id']; ?>)" class="btn btn-success"><i class="fa-solid fa-rotate-right"></i></button>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
